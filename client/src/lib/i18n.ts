...
const DICT: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'backendUsage.resetAt': '{time} 리셋',
    'backendUsage.fiveHourLimit': '5시간 한도',
    'backendUsage.sevenDayLimit': '주간 한도',
    ...
    'backendUsage.tokenOnly': '한도 조회 불가',
    'backendUsage.tokenOnlyTip': '토큰 인증됨 · 게이지를 보려면 claude login 필요',
    'backendUsage.stale': '갱신 실패 — 마지막으로 조회된 수치',
    ...
    'backendsTab.fallbackTitle': '폴백 백엔드',
    'backendsTab.fallbackNone': '설정 안 함',
    'backendsTab.fallbackDesc': '에이전트에 백엔드가 지정돼 있지 않을 때 이 백엔드를 사용합니다.',
    'editAccount.fallbackTitle': '폴백 백엔드',
    'editAccount.fallbackNone': '설정 안 함',
    'editAccount.fallbackInherit': '전역 따름 (현재 {backend})',
    'editAccount.fallbackDesc': '이 계정이 실패했을 때 대신 사용할 백엔드. 개별 지정이 전역 폴백보다 우선합니다.',
    'backendsTab.applyAllTitle': '전체 에이전트 백엔드 일괄 적용',
    'backendsTab.applyAllButton': '일괄 적용',
    'backendsTab.applyAllFollowGlobal': '전역 설정 따르기',
    'backendsTab.applyAllDesc': '모든 에이전트의 백엔드를 한 번에 바꿉니다. 적용 후 되돌릴 수 있습니다.',
    'backendsTab.applyAllConfirmTitle': '일괄 적용을 실행할까요?',
    'backendsTab.applyAllConfirmBody': '에이전트 {count}개의 백엔드가 {target}(으)로 바뀝니다.',
    'backendsTab.applyAllConfirmBodyUnknown': '모든 에이전트의 백엔드가 {target}(으)로 바뀝니다.',
    'backendsTab.applyAllConfirmOk': '적용',
    'backendsTab.applyAllConfirmCancel': '취소',
    'backendsTab.applyAllProgress': '에이전트 백엔드 적용 중...',
    'backendsTab.applyAllDone': '에이전트 {count}개의 백엔드를 {target}(으)로 바꿨습니다.',
    'backendsTab.applyAllUndo': '되돌리기',
    'backendsTab.applyAllUndone': '에이전트 {count}개의 백엔드를 되돌렸습니다.',
    'backendsTab.applyAllFailed': '일괄 적용 실패: {error}',
    'backendsTab.applyAllUndoFailed': '되돌리기 실패: {error}',
    'backendsTab.applyTierButton': '티어 일괄 적용',
    'backendsTab.applyTierNone': '티어 해제 (고정 모델 사용)',
    'backendsTab.applyTierDesc': '모든 에이전트의 모델 티어를 한 번에 바꿉니다. 적용 후 되돌릴 수 있습니다.',
    'backendsTab.applyTierConfirmTitle': '티어를 일괄 적용할까요?',
    'backendsTab.applyTierConfirmBody': '에이전트 {count}개의 모델 티어가 {target}(으)로 바뀝니다.',
    'backendsTab.applyTierConfirmBodyUnknown': '모든 에이전트의 모델 티어가 {target}(으)로 바뀝니다.',
    'backendsTab.applyTierProgress': '에이전트 티어 적용 중...',
    'backendsTab.applyTierDone': '에이전트 {count}개의 티어를 {target}(으)로 바꿨습니다.',
    'backendsTab.applyTierUndone': '에이전트 {count}개의 티어를 되돌렸습니다.',
    'backendsTab.applyTierFailed': '티어 일괄 적용 실패: {error}',
    'backendsTab.tiersTitle': '모델 티어',
    'backendsTab.tiersDesc':
      '에이전트는 모델 대신 티어를 고르고, 티어가 어떤 모델이 되는지는 백엔드마다 따로 정합니다.',
    'backendsTab.tierKeyPlaceholder': '키 (예: ULTRA)',
    'backendsTab.tierLabelPlaceholder': '표시 이름 (예: 최고 성능)',
    'backendsTab.tierKeyDuplicate': '이미 있는 티어 키입니다.',
    'backendsTab.tierDelete': '티어 삭제',
    'backendsTab.tierDeleteConfirm':
      '티어 "{tier}" 를 삭제할까요? 이 티어를 쓰던 에이전트는 모델이 풀리지 않습니다.',
    ...
    'tierMap.unset': '미지정',
    'tierMap.stale': '목록에 없는 모델',
    'tierMap.noTiers': '정의된 티어가 없습니다 — Global 에서 추가하세요.',
    'tierMap.noModels': '이 백엔드에 등록된 모델이 없습니다 — 아래에서 단축명을 먼저 추가하세요.',
  ...
  en: {
    ...
    'backendUsage.resetAt': 'resets at {time}',
    'backendUsage.fiveHourLimit': '5-hour limit',
    'backendUsage.sevenDayLimit': 'Weekly limit',
    ...
    'backendUsage.tokenOnly': 'Usage unavailable',
    'backendUsage.tokenOnlyTip': 'Token authenticated · run claude login to see the usage gauge',
    'backendUsage.stale': 'Refresh failed — showing last known values',
    ...
    'backendsTab.fallbackTitle': 'Fallback backend',
    'backendsTab.fallbackNone': 'Not set',
    'backendsTab.fallbackDesc': 'Used when an agent has no backend of its own.',
    'editAccount.fallbackTitle': 'Fallback backend',
    'editAccount.fallbackNone': 'Not set',
    'editAccount.fallbackInherit': 'Follow global (currently {backend})',
    'editAccount.fallbackDesc': 'Backend to use when this account fails. Takes priority over the global fallback.',
    'backendsTab.applyAllTitle': 'Apply a backend to every agent',
    'backendsTab.applyAllButton': 'Apply to all',
    'backendsTab.applyAllFollowGlobal': 'Follow global setting',
    'backendsTab.applyAllDesc': 'Changes the backend of every agent at once. You can undo it afterwards.',
    'backendsTab.applyAllConfirmTitle': 'Apply to every agent?',
    'backendsTab.applyAllConfirmBody': 'This will change the backend of {count} agent(s) to {target}.',
    'backendsTab.applyAllConfirmBodyUnknown': 'This will change the backend of every agent to {target}.',
    'backendsTab.applyAllConfirmOk': 'Apply',
    'backendsTab.applyAllConfirmCancel': 'Cancel',
    'backendsTab.applyAllProgress': 'Applying backend to agents...',
    'backendsTab.applyAllDone': 'Changed the backend of {count} agent(s) to {target}.',
    'backendsTab.applyAllUndo': 'Undo',
    'backendsTab.applyAllUndone': 'Reverted the backend of {count} agent(s).',
    'backendsTab.applyAllFailed': 'Apply to all failed: {error}',
    'backendsTab.applyAllUndoFailed': 'Undo failed: {error}',
    'backendsTab.applyTierButton': 'Apply tier to all',
    'backendsTab.applyTierNone': 'Clear tier (use pinned model)',
    'backendsTab.applyTierDesc': 'Changes the model tier of every agent at once. You can undo it afterwards.',
    'backendsTab.applyTierConfirmTitle': 'Apply this tier to every agent?',
    'backendsTab.applyTierConfirmBody': 'This will change the model tier of {count} agent(s) to {target}.',
    'backendsTab.applyTierConfirmBodyUnknown': 'This will change the model tier of every agent to {target}.',
    'backendsTab.applyTierProgress': 'Applying tier to agents...',
    'backendsTab.applyTierDone': 'Changed the tier of {count} agent(s) to {target}.',
    'backendsTab.applyTierUndone': 'Reverted the tier of {count} agent(s).',
    'backendsTab.applyTierFailed': 'Apply tier to all failed: {error}',
    'backendsTab.tiersTitle': 'Model tiers',
    'backendsTab.tiersDesc':
      'Agents pick a tier instead of a model; each backend decides which model that tier resolves to.',
    'backendsTab.tierKeyPlaceholder': 'Key (e.g. ULTRA)',
    'backendsTab.tierLabelPlaceholder': 'Display name (e.g. Top quality)',
    'backendsTab.tierKeyDuplicate': 'That tier key already exists.',
    'backendsTab.tierDelete': 'Delete tier',
    'backendsTab.tierDeleteConfirm':
      'Delete the tier "{tier}"? Agents using it will no longer resolve to a model.',
    ...
    'tierMap.stale': 'not in model list',
    'tierMap.noTiers': 'No tiers defined — add one under Global.',
    'tierMap.noModels': 'This backend has no models registered — add an alias below first.',
